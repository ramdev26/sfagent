  ...
  if (failed && !data) {
    return (
      <>
        ...
        <Notice>
          The merchant API on port 8004 isn&apos;t reachable. Start it with{" "}
          <code className="rounded bg-(--well) px-1 font-mono text-[13px]">python scripts/run_demo.py supplement_factory --merchant</code> and reload.
        </Notice>
      </>
    );
  }
